...
### 🏥 Bridging the gap between Software Engineering and Healthcare

I am a 21-year-old **Software Engineer** from **Portugal**, passionate about using technology to solve complex problems in the medical field.

I have a strong foundation in computer science and I am currently specializing in **Medical Informatics**, focusing on how data, interoperability, and algorithms can improve patient outcomes and clinical workflows.

---

### 🎓 Education

**MSc in Medical Informatics** (Current)
*Faculty of Medicine (FMUP) & Faculty of Sciences (FCUP) - University of Porto*
* **Focus:** Health Information Systems, Data Science in Health, Clinical Decision Support, Interoperability (HL7/FHIR).

**BSc in Computer Engineering**
*University of Trás-os-Montes and Alto Douro (UTAD)*
* **Focus:** Software Engineering, Algorithms, Database Management, Distributed Systems.
...
* Studying standard data exchange protocols like **HL7 and FHIR**.
* Developing secure and scalable software solutions for clinical environments.
